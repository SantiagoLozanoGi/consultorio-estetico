...
export default function CitasAgendadasModal({ cita, onClose, onUpdated }: Props) {
  ...
  const handleConcluir = async () => {
    ...
    try {
      ...
      await api.post(`/citas/${cita.id}/confirmar-pago`, {
        monto,
        monto_pagado: pagadoAcumulado,
        metodo_pago: "Consultorio",
        tipo_pago_consultorio: modoPago,
      });
      setConcluida(true);
      ...
      >
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <button
            ...
            style={{ backgroundColor: "#E9DED2", borderRadius: "50%", width: 34, height: 34, padding: 0 }}
          >
            <ArrowLeft size={16} />
          </button>
          ...
          <div className="mb-4">
            ...
            <div className="d-flex gap-3 mb-3 flex-wrap">
              <div className="flex-1">
                <label className="form-label small fw-semibold" style={{ color: "#6C584C" }}>
                  Monto total (COP)
                </label>
                <input
                  type="number"
        ...
        <div className="d-flex gap-2 flex-wrap">
          ...
          {cita.estado === "confirmada" && !concluida && (
            <button
              ...
              disabled={saving}
              className="btn rounded-pill fw-semibold flex-1"
              style={{ backgroundColor: "#1B4F72", color: "#fff", border: "none" }}
            >
